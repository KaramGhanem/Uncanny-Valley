...
srun --immediate --exact --gres=gpu:a100:1 -n1 -c 4 --mem=16G -l --output=%j-step-%s.out python /network/scratch/k/karam.ghanem/Diffusion/minDiffusion/DDPM.py --channel 3  --save_and_sample_every 1 --sampling_timesteps 1000 --timesteps 1000 --experiment_name Langevin_cosine --data_path '/home/mila/k/karam.ghanem/scratch/Diffusion/cifar10_png/train' --fls_train_path "/network/scratch/k/karam.ghanem/Diffusion/minDiffusion/minDiffusion/datasets_cifar_big/cifar_train" --fls_test_path "/network/scratch/k/karam.ghanem/Diffusion/minDiffusion/minDiffusion/datasets_cifar_big/cifar_test" --milestone_path "/network/scratch/k/karam.ghanem/Diffusion/minDiffusion/DDPM_cosine_schedule_CIFAR10_results" &
srun --immediate --exact --gres=gpu:a100:1 -n1 -c 4 --mem=16G -l --output=%j-step-%s.out python /network/scratch/k/karam.ghanem/Diffusion/minDiffusion/DDPM.py --channel 3  --save_and_sample_every 1 --sampling_timesteps 1000 --timesteps 1000 --experiment_name Langevin_sigmoid --data_path '/home/mila/k/karam.ghanem/scratch/Diffusion/cifar10_png/train' --fls_train_path "/network/scratch/k/karam.ghanem/Diffusion/minDiffusion/minDiffusion/datasets_cifar_big/cifar_train" --fls_test_path "/network/scratch/k/karam.ghanem/Diffusion/minDiffusion/minDiffusion/datasets_cifar_big/cifar_test" --milestone_path "/network/scratch/k/karam.ghanem/Diffusion/minDiffusion/DDPM_sigmoid_schedule_CIFAR10_results" &
wait
