...
python /home/mila/k/karam.ghanem/Diffusion/minDiffusion/DDPM.py  ---save_and_sample_every 1250 --sampling_timesteps 1900 --timesteps 2000 --train_num_steps 2500  --experiment_name Langevin_Sampler_DDIM_cifar10_final --data_path '/home/mila/k/karam.ghanem/Diffusion/cifar10_png/train' 
