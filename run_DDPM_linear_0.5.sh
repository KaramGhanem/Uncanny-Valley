...
python /home/mila/k/karam.ghanem/scratch/Diffusion/minDiffusion/DDPM.py --channel 3 --save_and_sample_every 15625 --train_num_steps 156250 --sampling_timesteps 1000 --timesteps 1000 --experiment_name Langevin_Sampler_sigmoid_schedule_CIFAR10 --beta_schedule 'linear' --scaling_factor=0.5 --data_path '/home/mila/k/karam.ghanem/scratch/Diffusion/cifar10_png/train'
