...
python /home/mila/k/karam.ghanem/Diffusion/minDiffusion/DDPM_classifier.py  --save_and_sample_every 5000 --train_num_steps 20000 --sampling_timesteps 12000 --timesteps 12000  --experiment_name Langevin_Sampler_Classifier_cifar10_20k_fid --data_path '/home/mila/k/karam.ghanem/Diffusion/cifar10_png/train' 
