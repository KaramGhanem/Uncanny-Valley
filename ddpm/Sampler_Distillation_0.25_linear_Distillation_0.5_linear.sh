...
srun --immediate --exact --gres=gpu:a100:1 -n1 -c 4 --mem=16G -l --output=%j-step-%s.out python /network/scratch/k/karam.ghanem/Diffusion/minDiffusion/DDPM_distillation.py --channel 3  --save_and_sample_every 1 --sampling_timesteps 1000 --timesteps 1000 --experiment_name Distillation_linear_0.25 --data_path '/home/mila/k/karam.ghanem/scratch/Diffusion/cifar10_png/train' --fls_train_path "/network/scratch/k/karam.ghanem/Diffusion/minDiffusion/datasets_cifar_big/cifar_train" --fls_test_path "/network/scratch/k/karam.ghanem/Diffusion/minDiffusion/datasets_cifar_big/cifar_test" --milestone_path "/network/scratch/k/karam.ghanem/Diffusion/minDiffusion/DDPM_linear_0.25_schedule_CIFAR10_results" &
srun --immediate --exact --gres=gpu:a100:1 -n1 -c 4 --mem=16G -l --output=%j-step-%s.out python /network/scratch/k/karam.ghanem/Diffusion/minDiffusion/DDPM_distillation.py --channel 3  --save_and_sample_every 1 --sampling_timesteps 1000 --timesteps 1000 --experiment_name Distillation_linear_0.5 --data_path '/home/mila/k/karam.ghanem/scratch/Diffusion/cifar10_png/train' --fls_train_path "/network/scratch/k/karam.ghanem/Diffusion/minDiffusion/datasets_cifar_big/cifar_train" --fls_test_path "/network/scratch/k/karam.ghanem/Diffusion/minDiffusion/datasets_cifar_big/cifar_test" --milestone_path "/network/scratch/k/karam.ghanem/Diffusion/minDiffusion/DDPM_linear_0.5_schedule_CIFAR10_results" &
wait
