...
from guided_diffusion import guided_diffusion 
...
def create_argparser():
    defaults = dict(
        ...
        batch_size=32,
        use_ddim=False,
        classifier_path="/home/mila/k/karam.ghanem/scratch/Diffusion/minDiffusion/guided_diffusion/checkpoints/200epochsclassifier/model156250.pt",
        classifier_scale=10,
    )
