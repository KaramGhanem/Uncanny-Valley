                ...
                if accelerator.is_main_process:
                    ...
                    if self.step != 0 and self.step % self.save_and_sample_every == 0:
                        ...
                        for count,image in enumerate(all_images_list):
                            utils.save_image(image[0], str(self.results_folder / f'sample-{milestone}_{count}.png'))
                        ...
                        if exists(self.inception_v3):
                            ###
                            ###FIX FLS SCORE, YOU NEED PUT THE IMAGESTHAT ARE NOT PART OF A GRID IN A FOLDER AND
                            ###AND USE THEM AS AN INPUT TO GEN=FOLDER, LOOK AT SAMPLER FUNCTION
                            ###
                            ...
                            #Will give an error until fixed
                            fls_score = compute_metrics(train=self.fls_train_path, test=self.fls_test_path, gen=' dd') 
