...
python /home/mila/k/karam.ghanem/Diffusion/minDiffusion/DDPM.py --channel 3  --save_and_sample_every 1 --sampling_timesteps 1000 --timesteps 1000 --experiment_name Langevin_sigmoid --data_path '/home/mila/k/karam.ghanem/scratch/Diffusion/cifar10_png/train' --fls_train_path "/home/mila/k/karam.ghanem/scratch/Diffusion/minDiffusion/datasets_cifar_big/cifar_train" --fls_test_path "/home/mila/k/karam.ghanem/scratch/Diffusion/minDiffusion/datasets_cifar_big/cifar_test" --milestone_path " "
