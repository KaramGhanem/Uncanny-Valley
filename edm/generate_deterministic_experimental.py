...
def main(network_pkl , outdir , subdirs = False,  class_idx = None, max_batch_size = 64 , device=torch.device('cuda'), **sampler_kwargs):
    ...
    for batch_seeds in tqdm.tqdm(rank_batches, unit='batch', disable=(dist.get_rank() != 0)):
        ...
        inception_score_mean.append(inception_score_val[0])
        inception_score_std.append(inception_score_val[1])
    ...
    image = torch.cat(torch.chunk(images, 2, dim=0), dim = 0)
    inception_score_mean = np.average(inception_score_mean)
    inception_score_std = np.average(inception_score_std)
    ...
    fid = fid_score(image ,  "/home/mila/k/karam.ghanem/scratch/Diffusion/minDiffusion/datasets_cifar_big/cifar_train")
...
if __name__ == "__main__":
    ...
    main("/home/mila/k/karam.ghanem/scratch/Diffusion/minDiffusion/edm/training-runs/00008-cifar10-32x32-cond-ddpmpp-edm-gpus1-batch512-fp32/network-snapshot-000502.pkl", "/home/mila/k/karam.ghanem/scratch/Diffusion/minDiffusion/edm/training-runs/00008-cifar10-32x32-cond-ddpmpp-edm-gpus1-batch512-fp32/second_checkpoint")
    main("/home/mila/k/karam.ghanem/scratch/Diffusion/minDiffusion/edm/training-runs/00008-cifar10-32x32-cond-ddpmpp-edm-gpus1-batch512-fp32/network-snapshot-001004.pkl", "/home/mila/k/karam.ghanem/scratch/Diffusion/minDiffusion/edm/training-runs/00008-cifar10-32x32-cond-ddpmpp-edm-gpus1-batch512-fp32/third_checkpoint")
    main("/home/mila/k/karam.ghanem/scratch/Diffusion/minDiffusion/edm/training-runs/00008-cifar10-32x32-cond-ddpmpp-edm-gpus1-batch512-fp32/network-snapshot-001505.pkl", "/home/mila/k/karam.ghanem/scratch/Diffusion/minDiffusion/edm/training-runs/00008-cifar10-32x32-cond-ddpmpp-edm-gpus1-batch512-fp32/fourth_checkpoint")
    main("/home/mila/k/karam.ghanem/scratch/Diffusion/minDiffusion/edm/training-runs/00008-cifar10-32x32-cond-ddpmpp-edm-gpus1-batch512-fp32/network-snapshot-002007.pkl", "/home/mila/k/karam.ghanem/scratch/Diffusion/minDiffusion/edm/training-runs/00008-cifar10-32x32-cond-ddpmpp-edm-gpus1-batch512-fp32/fifth_checkpoint")
#----------------------------------------------------------------------------
