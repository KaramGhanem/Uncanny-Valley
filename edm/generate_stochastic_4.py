...
if __name__ == "__main__":
    ...
    config={
    "architecture": "EDM - unconditioned NCSNPP - Stochastic Sampler"
    }
    )   
    ...
    main("/network/scratch/k/karam.ghanem/Diffusion/minDiffusion/edm/training-runs/00024-cifar10-32x32-uncond-ncsnpp-edm-gpus1-batch32-fp32/network-snapshot-004722.pkl", "/network/scratch/k/karam.ghanem/Diffusion/minDiffusion/edm/training-runs/00024-cifar10-32x32-uncond-ncsnpp-edm-gpus1-batch32-fp32/tenth_checkpoint")
#----------------------------------------------------------------------------
