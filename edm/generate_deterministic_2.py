...
def fid_score(fake_samples, ref_path): 
        ...
        ds = Dataset(ref_path, 63, augment_horizontal_flip = False, convert_image_to = None)
        dl = DataLoader(ds, batch_size = 63, shuffle = True, pin_memory = True, num_workers = cpu_count())
...
if __name__ == "__main__":
    ...
    config={
    "architecture": "EDM - unconditioned DDPMPP - Original Sampler"
    }
    )   

    #CIFAR10
    main("/network/scratch/k/karam.ghanem/Diffusion/minDiffusion/edm/training-runs/00022-cifar10-32x32-uncond-ddpmpp-edm-gpus1-batch32-fp32/network-snapshot-000452.pkl", "/network/scratch/k/karam.ghanem/Diffusion/minDiffusion/edm/training-runs/00022-cifar10-32x32-uncond-ddpmpp-edm-gpus1-batch32-fp32/first_checkpoint")
    main("/network/scratch/k/karam.ghanem/Diffusion/minDiffusion/edm/training-runs/00022-cifar10-32x32-uncond-ddpmpp-edm-gpus1-batch32-fp32/network-snapshot-000954.pkl", "/network/scratch/k/karam.ghanem/Diffusion/minDiffusion/edm/training-runs/00022-cifar10-32x32-uncond-ddpmpp-edm-gpus1-batch32-fp32/second_checkpoint")
    main("/network/scratch/k/karam.ghanem/Diffusion/minDiffusion/edm/training-runs/00022-cifar10-32x32-uncond-ddpmpp-edm-gpus1-batch32-fp32/network-snapshot-001456.pkl", "/network/scratch/k/karam.ghanem/Diffusion/minDiffusion/edm/training-runs/00022-cifar10-32x32-uncond-ddpmpp-edm-gpus1-batch32-fp32/third_checkpoint")
    main("/network/scratch/k/karam.ghanem/Diffusion/minDiffusion/edm/training-runs/00022-cifar10-32x32-uncond-ddpmpp-edm-gpus1-batch32-fp32/network-snapshot-001959.pkl", "/network/scratch/k/karam.ghanem/Diffusion/minDiffusion/edm/training-runs/00022-cifar10-32x32-uncond-ddpmpp-edm-gpus1-batch32-fp32/fourth_checkpoint")
    main("/network/scratch/k/karam.ghanem/Diffusion/minDiffusion/edm/training-runs/00022-cifar10-32x32-uncond-ddpmpp-edm-gpus1-batch32-fp32/network-snapshot-002461.pkl", "/network/scratch/k/karam.ghanem/Diffusion/minDiffusion/edm/training-runs/00022-cifar10-32x32-uncond-ddpmpp-edm-gpus1-batch32-fp32/fifth_checkpoint")
    main("/network/scratch/k/karam.ghanem/Diffusion/minDiffusion/edm/training-runs/00022-cifar10-32x32-uncond-ddpmpp-edm-gpus1-batch32-fp32/network-snapshot-002964.pkl", "/network/scratch/k/karam.ghanem/Diffusion/minDiffusion/edm/training-runs/00022-cifar10-32x32-uncond-ddpmpp-edm-gpus1-batch32-fp32/sixth_checkpoint")
    main("/network/scratch/k/karam.ghanem/Diffusion/minDiffusion/edm/training-runs/00022-cifar10-32x32-uncond-ddpmpp-edm-gpus1-batch32-fp32/network-snapshot-003466.pkl", "/network/scratch/k/karam.ghanem/Diffusion/minDiffusion/edm/training-runs/00022-cifar10-32x32-uncond-ddpmpp-edm-gpus1-batch32-fp32/seventh_checkpoint")
    main("/network/scratch/k/karam.ghanem/Diffusion/minDiffusion/edm/training-runs/00022-cifar10-32x32-uncond-ddpmpp-edm-gpus1-batch32-fp32/network-snapshot-003968.pkl", "/network/scratch/k/karam.ghanem/Diffusion/minDiffusion/edm/training-runs/00022-cifar10-32x32-uncond-ddpmpp-edm-gpus1-batch32-fp32/eighth_checkpoint")
    main("/network/scratch/k/karam.ghanem/Diffusion/minDiffusion/edm/training-runs/00022-cifar10-32x32-uncond-ddpmpp-edm-gpus1-batch32-fp32/network-snapshot-004471.pkl", "/network/scratch/k/karam.ghanem/Diffusion/minDiffusion/edm/training-runs/00022-cifar10-32x32-uncond-ddpmpp-edm-gpus1-batch32-fp32/ninth_checkpoint")
    main("/network/scratch/k/karam.ghanem/Diffusion/minDiffusion/edm/training-runs/00022-cifar10-32x32-uncond-ddpmpp-edm-gpus1-batch32-fp32/network-snapshot-004622.pkl", "/network/scratch/k/karam.ghanem/Diffusion/minDiffusion/edm/training-runs/00022-cifar10-32x32-uncond-ddpmpp-edm-gpus1-batch32-fp32/tenth_checkpoint")


    #CHANGE FID REFERENCE DATASET TO IMAGENET TEST SET
    # main("/network/scratch/k/karam.ghanem/Diffusion/minDiffusion/edm/training-runs/00014-imagenet-64x64-uncond-ddpmpp-edm-gpus1-batch512-fp32/network-snapshot-000502.pkl", "/network/scratch/k/karam.ghanem/Diffusion/minDiffusion/edm/training-runs/00014-imagenet-64x64-uncond-ddpmpp-edm-gpus1-batch512-fp32/second_checkpoint")
    # main("/network/scratch/k/karam.ghanem/Diffusion/minDiffusion/edm/training-runs/00014-imagenet-64x64-uncond-ddpmpp-edm-gpus1-batch512-fp32/network-snapshot-001004.pkl", "/network/scratch/k/karam.ghanem/Diffusion/minDiffusion/edm/training-runs/00014-imagenet-64x64-uncond-ddpmpp-edm-gpus1-batch512-fp32/third_checkpoint")
    # main("/network/scratch/k/karam.ghanem/Diffusion/minDiffusion/edm/training-runs/00014-imagenet-64x64-uncond-ddpmpp-edm-gpus1-batch512-fp32/network-snapshot-001505.pkl", "/network/scratch/k/karam.ghanem/Diffusion/minDiffusion/edm/training-runs/00014-imagenet-64x64-uncond-ddpmpp-edm-gpus1-batch512-fp32/fourth_checkpoint")
    # main("/network/scratch/k/karam.ghanem/Diffusion/minDiffusion/edm/training-runs/00014-imagenet-64x64-uncond-ddpmpp-edm-gpus1-batch512-fp32/network-snapshot-002007.pkl", "/network/scratch/k/karam.ghanem/Diffusion/minDiffusion/edm/training-runs/00014-imagenet-64x64-uncond-ddpmpp-edm-gpus1-batch512-fp32/fifth_checkpoint")
    # main("/network/scratch/k/karam.ghanem/Diffusion/minDiffusion/edm/training-runs/00014-imagenet-64x64-uncond-ddpmpp-edm-gpus1-batch512-fp32/network-snapshot-002509.pkl", "/network/scratch/k/karam.ghanem/Diffusion/minDiffusion/edm/training-runs/00014-imagenet-64x64-uncond-ddpmpp-edm-gpus1-batch512-fp32/sixth_checkpoint")
    # main("/network/scratch/k/karam.ghanem/Diffusion/minDiffusion/edm/training-runs/00014-imagenet-64x64-uncond-ddpmpp-edm-gpus1-batch512-fp32/network-snapshot-003011.pkl", "/network/scratch/k/karam.ghanem/Diffusion/minDiffusion/edm/training-runs/00014-imagenet-64x64-uncond-ddpmpp-edm-gpus1-batch512-fp32/seventh_checkpoint")
    # main("/network/scratch/k/karam.ghanem/Diffusion/minDiffusion/edm/training-runs/00014-imagenet-64x64-uncond-ddpmpp-edm-gpus1-batch512-fp32/network-snapshot-003512.pkl", "/network/scratch/k/karam.ghanem/Diffusion/minDiffusion/edm/training-runs/00014-imagenet-64x64-uncond-ddpmpp-edm-gpus1-batch512-fp32/eighth_checkpoint")
    # main("/network/scratch/k/karam.ghanem/Diffusion/minDiffusion/edm/training-runs/00014-imagenet-64x64-uncond-ddpmpp-edm-gpus1-batch512-fp32/network-snapshot-004014.pkl", "/network/scratch/k/karam.ghanem/Diffusion/minDiffusion/edm/training-runs/00014-imagenet-64x64-uncond-ddpmpp-edm-gpus1-batch512-fp32/ninth_checkpoint")
#----------------------------------------------------------------------------
